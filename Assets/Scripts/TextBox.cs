...
public class TextBox : MonoBehaviour
{
    ...
    private void OnLevelWasLoaded(int level)
    {
        ...
        day1Script.Add("Thank you for agreeing to help take care of " + bunny.bunnyName + "! (press space for next dialogue)");
        day1Script.Add("In order to be the best friend of " + bunny.bunnyName + ", first you need to learn the controls.");
        ...
        day1Script.Add("Bring the item to " + bunny.bunnyName + " and press the left mouse button to use it on " + bunny.bunnyName + ".");
